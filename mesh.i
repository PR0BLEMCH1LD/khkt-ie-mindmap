...
#pragma clang diagnostic pop
#pragma warning(pop)
# 8 "src\\gfx/../util/utils.h" 2
# 1 "C:\\Program Files\\Microsoft Visual Studio\\2022\\Community\\VC\\Tools\\Llvm\\x64\\lib\\clang\\15.0.1\\include\\stddef.h" 1 3
# 9 "src\\gfx/../util/utils.h" 2
...
# 13 "src\\gfx/../util/utils.h" 2

# 1 "src\\gfx/../util/types.h" 1
...
# 15 "src\\gfx/../util/utils.h" 2
# 1 "src\\gfx/../util/macros.h" 1
# 16 "src\\gfx/../util/utils.h" 2
# 1 "src\\gfx/../util/fmath.h" 1



# 1 "C:\\Program Files (x86)\\Windows Kits\\10\\Include\\10.0.22000.0\\ucrt\\math.h" 1 3
# 5 "src\\gfx/../util/fmath.h" 2
# 18 "src\\gfx/../util/fmath.h"
...
# 17 "src\\gfx/../util/utils.h" 2
# 1 "src\\gfx/../util/timer.h" 1
...
# 1 "src\\gfx/../world/../gfx/camera.h" 1
...
void mesh_render(Mesh *self) {
 ...
 vao_bind(&self->vao);
 BaseMeshBuffer indices = (*(BaseMeshBuffer *)((char *)(self)->data.raw + (self->data.length - 1) * sizeof(BaseMeshBuffer)));
 bo_bind(&indices.bo);
 glad_glDrawElements(0x0004, indices.data.length, indices.gl_type, 0);
}

void mesh_destroy(Mesh *self) {
 vao_destroy(&self->vao);
 for (u32 i = 0; i < self->data.length; i++) {
  bo_destroy(&(*(BaseMeshBuffer *)((char *)(self)->data.raw + (i) * sizeof(BaseMeshBuffer))).bo);
 }
 free(self->data.raw);
}
